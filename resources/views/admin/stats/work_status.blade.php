    ...
    <table  class="table table-bordered table-hover table-striped">
      <tbody>
        @foreach ($arryearOfGraduation as $key=>$value)
          <tr>
            <td>
          <a href="/admin/stats/work_status_by_year?year=<?php echo $value->yearOfGraduation;?>">- <?php echo $value->yearOfGraduation;?></a>
        </td>
          </tr>
        @endforeach
      </tbody>
     ...
     <table  class="table table-bordered table-hover table-striped">
      <tbody>
        @foreach ($arrBranch as $key=>$value)
          <tr>
            <td>
          <a href="/admin/stats/work_status_by_branch?branch=<?php echo $value->branch;?>">- <?php echo $value->branch;?></a>
        </td>
          </tr>
        @endforeach
          </table>
